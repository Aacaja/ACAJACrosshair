...
def build_executable():
    ...
    # 创建版本信息文件
    version_info = f"""准星程序 v2.0.0 版本信息
...
"""
    ...
    with open(os.path.join(release_dir, "版本说明_v2.0.0.txt"), "w", encoding="utf-8") as f:
        f.write(version_info)
    
    print("[OK] 创建版本说明文件")
    
    # 压缩发布包
    zip_name = "准星程序_v2.0.0.zip"
